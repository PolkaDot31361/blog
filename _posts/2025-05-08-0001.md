...
Keep in mind that this $$q$$ is rational number.  
Then  
...
> For every $$p$$ in $$A$$ we found a rational $$q$$ such that $$p < q$$ and $$q$$ is in $$A$$. And thus $$A$$ has no largeset element.  
...
- If $$x$$ is not a member  of $$aa$, we write $$x \notin A$$.  
